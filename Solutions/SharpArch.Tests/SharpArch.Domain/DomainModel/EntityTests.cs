...
namespace Tests.SharpArch.Domain.DomainModel
{
    ...
    public class EntityTests
    {
        ...
        public class ObjectWithOneDomainSignatureProperty : EntityWithTypedId<int>
        {
            [DomainSignature]
        ...
        private class AddressBeingDomainSignatureComparble : EntityWithTypedId<int>
        {
            [DomainSignature]
        ...
        private class Object1 : EntityWithTypedId<int>
        {
        }

        private class Object2 : EntityWithTypedId<int>
        {
        }

        private class ObjectWithAllDomainSignatureProperty : EntityWithTypedId<int>
        {
            [DomainSignature]
            public int Age { get; set; }
            [DomainSignature]
        ...
        private class ObjectWithComplexProperties : EntityWithTypedId<int>
        {
            [DomainSignature]
        ...
        private class ObjectWithIdenticalTypedProperties : EntityWithTypedId<int>
        {
            [DomainSignature]
            public string Address { get; set; }
            [DomainSignature]
        ...
        private class ObjectWithIntId : EntityWithTypedId<int>
        {
            [DomainSignature]
            public string Name { get; set; }
        }
        ...
        /// </summary>
        private class ObjectWithNoDomainSignatureProperties : EntityWithTypedId<int>
        {
            public int Age { get; set; }
        ...
        private class Contact : EntityWithTypedId<int>
        {
